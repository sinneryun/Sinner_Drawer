...
-(void)leftTableView{
    NSArray *btnTitleNameArray = [NSArray arrayWithObjects:@"   按钮一",@"   按钮二",@"   按钮三",@"   按钮四",@"   按钮五", nil];
...
-(void) loginBtnClick:(UIButton *) loginBtnClick{
    ...
    if (self.loginBtnClickDelegate) {
        [self.loginBtnClickDelegate loginBtnClick:loginBtnClick];
    }
}
